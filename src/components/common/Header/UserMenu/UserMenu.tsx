  ...
  return (
    <div className="relative flex items-center gap-2">
      ...
      <Popover isOpen={open} onClose={close} align="right" className="mt-3">
        {/* HEADER CON ROL (Estudiante / Docente / Admin) */}
        <MenuHeader
          ...
          <li>
            ...
            >
              <span className="menu-icon">
                <Logout size={18} color="var(--accent-red)" className="text-[--accent-red]" />
              </span>
...
// HEADER ORIGINAL (con ícono de estudiante/docente)
function MenuHeader({ roleLabel, iconName }: { roleLabel: string; iconName: 'student' | 'teacher' }) {
  ...
  return (
    <div className="px-3.5 pt-3 pb-2">
      <div className="flex items-center gap-2.5 rounded-t-xl border border-[var(--border)] bg-[var(--section)] px-2.5 py-1.5">
